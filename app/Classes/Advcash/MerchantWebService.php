...
if (!class_exists("MerchantWebService")) {
    ...
    {
        /**
         * Provide namespace string for class loading and arguments validation
         * @access private
         */
        private string $namespaceString = __NAMESPACE__ . "\\";
        ...
        public function __construct($wsdl = "https://wallet.advcash.com/wsm/merchantWebService?wsdl", $options = array())
        {
            foreach (self::$classmap as $wsdlClassName => $phpClassName) {
                if (!isset($options['classmap'][$wsdlClassName])) {
                    $options['classmap'][$wsdlClassName] = $this->namespaceString . $phpClassName;
                }
            }
        ...
        public function _checkArguments($arguments, $validParameters)
        {
            ...
            foreach ($arguments as $arg) {
                ...
                if ($type === "object") {
                    $type = get_class($arg);
                    $type = str_replace($this->namespaceString, '', $type);
                }
                $variables .= "(" . $type . ")";
            }
         ...
         * @throws Exception invalid function signature message
         */
        public function findTransaction($mixed = null): findTransactionResponse
        {
            $validParameters = array(
                "(findTransaction)",
            );
