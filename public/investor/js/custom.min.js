...
function deployNotification(notification) {
    ...
    return {
        init: function() {
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(), jQuery(".metismenu > .mm-active ").each(function() {
                ...
                }), jQuery(".deznav-scroll").length > 0 && (new PerfectScrollbar(".deznav-scroll").isRtl = !1), $(".btn-number").on("click", function(e) {
        ...
        load: function() {
            ...
            }, 1500), jQuery(".default-select").length > 0 && jQuery(".default-select").niceSelect()
        },
        resize: function() {
            t()
        }
